    ...
    <Transition name="lang-pop">
      ...
      >
        ...
        <button
          ...
          :lang="l.code"
          class="flex w-full items-center justify-between rounded-xl px-2.5 py-1.5 text-left text-[13px] text-ink transition-colors hover:bg-ink/6 focus:bg-ink/6 focus:outline-none"
